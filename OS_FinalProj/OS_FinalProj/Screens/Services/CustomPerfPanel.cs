...
{
    public partial class CustomPerfPanel : UserControl
    {
        ...
        public CustomPerfPanel(FormMain form, SupabaseClient supabaseClient, string userId = null)
        {
            InitializeComponent();
            mainForm = form;
            ...
            {
                { btnPerfTuning,   new Guid("af6b0be0-bd94-4543-a589-86f85f782ddf") },
                { btnSuspUp,       new Guid("e35c34f1-b2b3-4c26-8fe8-b838094900c4") },
                { btnExhaustSys,   new Guid("81aebb49-1c64-4785-8706-19f36655d486") },
                { btnCustomFab,    new Guid("7861e1c0-014d-4dce-9223-3f8f00b302bc") }
            };
