...
{
    public partial class EngineTransPanel : UserControl
    {
        ...
        public EngineTransPanel(FormMain form, SupabaseClient supabaseClient, string userId = null)
        {
            InitializeComponent();
            mainForm = form;
            ...
            {
                { btnTransFluChange,    new Guid("c4bef72a-05d4-4206-899d-c0f89627b7a0") },
                { btnTimeBeltRep,       new Guid("7b7a963c-1461-4a82-a99b-59aab41e6191") },
                { btnEngiDiag,          new Guid("64ddb6d8-b20c-427f-8576-6568c8674e7e") },
                { btnSparkPlugRep,      new Guid("e6cff8c2-b117-4c4d-9b40-9abafe23765d") },
            };
