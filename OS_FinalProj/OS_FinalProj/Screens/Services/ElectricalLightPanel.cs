...
namespace OS_FinalProj.Screens.Services
{
    public partial class ElectricalLightPanel : UserControl
    {
        ...
        public ElectricalLightPanel(FormMain form, SupabaseClient supabaseClient, string userId = null)
        {
            InitializeComponent();
            mainForm = form;
            ...
            {
                { btnHeadBrakeRep,     new Guid("748c4258-9ae8-435e-897f-e9e26b92d9c8") },
                { btnAlternatorRep,    new Guid("03bacec3-98c6-4a8a-9b76-8f64b06bc647") },
                { btnWireFuseRep,      new Guid("515c7e7e-9059-4acb-8808-dd943dfa2552") },
                { btnStartMotRep,      new Guid("f44e2ca4-835a-418b-a627-e8e3669acf47") },
            };
