...
{
    public partial class HeatingAirConPanel : UserControl
    {
        ...
        public HeatingAirConPanel(FormMain form, SupabaseClient supabaseClient, string userId = null)
        {
            InitializeComponent();
            mainForm = form;
            ...
            {
                { btnAcRec,         new Guid("6a67a130-20ed-41fd-a944-83d4bf716b39") },
                { btnHeatCorRep,    new Guid("70b4b28c-a65e-4faf-9e26-f94f91967386") },
                { btnAcSystemRep,   new Guid("365bbfe8-44b8-4eb1-9c52-18f316202447") },
                { btnCabAirRep,     new Guid("ff8cccf0-1ac4-43a3-bd2a-08d088b1d541") },
            };
