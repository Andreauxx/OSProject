...
{
    public partial class GeneralServicesPanel : UserControl
    {
        ...
        public GeneralServicesPanel(FormMain form, SupabaseClient supabaseClient, string userId = null)
        {
            InitializeComponent();
            mainForm = form;
            ...
            {
                { btnOilChange,        new Guid("c47f218c-8fce-4ca1-a758-c1d66654bb2c") },
                { btnBrakeFluidRep,    new Guid("e83d5e53-50a0-47bd-9bcd-a2ecc2c542a0") },
                { btnAirFiltRep,       new Guid("d0dcfd3a-851a-4751-81ec-755759957d3e") },
                { btnTireRot,          new Guid("91b0fdb7-8292-46a3-8fd1-3a2f4fcf4422") },
                { btnBattRep,          new Guid("ce7672db-8b0c-46a5-9abd-e255373171e3") },
            };
